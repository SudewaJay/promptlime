...
import { Spotlight } from "@/components/ui/spotlight"; // Ensure you have this file
  ...
  return (
    <section className="relative flex h-[40rem] w-full overflow-hidden rounded-md bg-black/[0.96] antialiased md:items-center md:justify-center">
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl p-4 pt-20 md:pt-0">
        <h1 className="text-center text-4xl md:text-7xl font-bold text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-clip-text">
          About Promptlime
        </h1>
        <p className="mx-auto mt-4 max-w-xl text-center text-base text-neutral-300">
